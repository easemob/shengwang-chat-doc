...
在您阅读此文档时，我们假定您已经具备了基础的 Android 应用开发经验，并能够理解相关基础概念。此文档是针对导入 EaseIMKit 库的快速集成文档，如果只是导入 SDK 集成使用，请参考 [环信即时通讯 IM Android 快速开始](/docs/sdk/android/quickstart.html)。
...
:::tip 重大变动
远程仓库统一由 JCenter 迁移到 `MavenCentral`，依赖库的域名由 “com.hyphenate” 修改为 “io.hyphenate”，详见 [环信即时通讯 IM Android 快速开始](/docs/sdk/android/quickstart.html)。
:::
...
版本号参考 [Android SDK 更新日志](/docs/sdk/android/releasenote.html)。
:::
...
:::tip
要实现自定义头像及昵称，请参考 [设置头像和昵称](/docs/sdk/android/userprofile.html#设置当前用户的属性)。
:::
