...
- 支持[会话推送通知方式的本地存储](/docs/sdk/harmonyos/push/push_notification_mode_dnd.html#从服务器获取所有会话的推送通知方式设置):
...
- 新增[设置推送通知的显示内容](/docs/sdk/harmonyos/push/push_display.html) 、[推送通知方式和免打扰模式功能](/docs/sdk/harmonyos/push/push_notification_mode_dnd.html)。
...
- 支持 [HarmonyOS 推送](/docs/sdk/harmonyos/push/push_overview.html)能力。
