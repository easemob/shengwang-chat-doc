...
即时通讯 IM 提供多个接口实现子区管理，包括子区的创建、获取、修改和删除等。**若你当前套餐不支持该功能，需升级产品套餐。**
...
curl -X GET https://XXXX/app-id/XXXX/thread -H 'Authorization: Bearer <YourAppToken>'
```
...
curl -X GET https://XXXX/app-id/XXXX/threads/user/test4 -H 'Authorization: Bearer <YourAppToken>'
```
...
curl -X GET https://XXXX/app-id/XXXX/threads/chatgroups/XXXX/user/XXXX -H 'Authorization: Bearer <YourAppToken>'
```
...
curl -X POST https://XXXX/app-id/XXXX/thread -H 'Authorization: Bearer <YourAppToken>' -H 'Content-Type:application/json' -d '{
...
curl -X PUT https://XXXX/app-id/XXXX/thread/1XXXX7 -H 'Authorization: Bearer <YourAppToken>' -d '{"name": "test4"}'
```
...
curl -X DELETE https://XXXX/app-id/XXXX/thread/1XXXX7 -H 'Authorization: Bearer <YourAppToken>'
```
...
即时通讯 IM 提供多个接口实现子区成员管理，包括对加入和踢出子区等管理功能。
...
curl -X GET https://XXXX/app-id/XXXX/thread/1XXXX7/users -H 'Authorization: Bearer <YourAppToken>'
```
...
```http
POST https://{host}/app-id/{app_id}/thread/{thread_id}/users
```
...
curl -X POST https://XXXX/app-id/XXXX/thread/1XXXX7/users -d '{
"usernames": [
"test2",
"test3"
]
...
```http
DELETE https://{host}/app-id/{app_id}/thread/{thread_id}/users
```
...
curl -X DELETE https://XXXX/app-id/XXXX/thread/1XXXX7/users -H 'Authorization: Bearer <YourAppToken>'
```
