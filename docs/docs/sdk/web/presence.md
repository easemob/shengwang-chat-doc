...
chatClient.subscribePresence(option).then((res) => {
  console.log(res);
});
```
...
chatClient.publishPresence(option).then((res) => {
  console.log(res);
});
```
...
chatClient.unsubscribePresence(option).then((res) => {
  console.log(res);
});
```
...
chatClient.getSubscribedPresencelist(option).then((res) => {
  console.log(res);
});
```
...
chatClient.getPresenceStatus(option).then((res) => {
  console.log(res);
});
```
