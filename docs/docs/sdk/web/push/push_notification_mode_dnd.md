...
chatClint.setSilentModeForAll(params);
```
...
chatClint.getSilentModeRemindTypeConversations({ pageSize: 10 });
```
...
chatClint.setSilentModeForConversation(params);
```
...
chatClint.getSilentModeForConversation(params);
```
...
chatClint.getSilentModeForConversations(params);
```
...
chatClint.clearRemindTypeForConversation(params);
```
