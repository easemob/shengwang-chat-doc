...
1. 使用该特性前，请确保在 [声网控制台](https://console.shengwang.cn/overview) 上开通该功能。
...
1. 使用该特性前，请确保在 [声网控制台](https://console.shengwang.cn/overview) 上已开通该功能。
...
本功能使用 SDK 的透传消息实现，详见 [SDK 相关文档](/document/web/typing_indication.html)。
