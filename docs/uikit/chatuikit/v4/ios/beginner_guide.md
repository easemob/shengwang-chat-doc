...
| [初始化](chatuikit_quickstart.html#第三步-初始化) <br/><br/> [登录](chatuikit_quickstart.html#第四步-登录)         | - **初始化**：使用单群聊 UIKit 的各项功能前，必须先初始化。传入你应用的 App ID 进行 [初始化](chatuikit_quickstart.html#第三步-初始化)。初始化时，可配置 [ChatOptions](chatuikit_advancedusage.html#初始化) 中的选项，例如，自动登录和是否开启 Console 日志。<br/> - **登录**：使用创建的用户 [登录 IM](/document/ios/login.html#登录)。登录成功后，你可以创建聊天、会话列表和通讯录等页面。|
| [创建聊天页面](chatuikit_quickstart.html#第五步-创建聊天页面)       | 创建聊天页面。详见 [快速开始](chatuikit_quickstart.html#第五步-创建聊天页面)。 |
| 自定义页面        | 若默认的聊天或会话列表等页面无法满足你的要求，你可以自定义页面，例如，[设置消息气泡](chatuikit_custom_chat.html#设置消息气泡的样式)、[会话头像](chatuikit_custom_conversation_list_advanced.html#设置会话头像)、[会话左滑和右滑菜单](chatuikit_custom_conversation_list_advanced.html#设置会话侧滑菜单)等。<br/> - [自定义会话列表页面](chatuikit_custom_conversation_list_basic.html)<br/> - [自定义聊天页面](chatuikit_custom_chat.html)<br/> - [自定义通讯录页面](chatuikit_custom_contact_list.html)<br/> - [自定义好友详情页面](chatuikit_custom_contact_details.html)<br/> - [自定义群详情页面](chatuikit_custom_group_details.html)。|
