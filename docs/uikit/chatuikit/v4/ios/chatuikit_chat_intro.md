...
单群聊 UIKit 提供 `MessageListController` 方便用户快速集成聊天页面和自定义聊天页面。
...
<ImageGallery>
  <ImageItem src="/images/uikit/chatuikit/ios/custom_chat.png" title="聊天页面 MessageListController.swift" />
</ImageGallery>

### 标题栏

聊天页面与会话列表页面、通讯录页面、群详情页面和好友详情页面的标题栏均使用 `ChatNavigationBar`。详见 [设置页面标题栏](chatuikit_custom_titlebar.html)。
