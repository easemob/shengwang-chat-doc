...
curl -X POST 'https://XXXX/app-id/{app_id}/chatrooms' \
...
1. 使用该功能前，你需**联系商务经理**。功能开通后，你也可以 [基于自定义群组 ID 创建群组](group_create.html#请求-body-参数)。
...
| 403     | exceed_limit | appId:XXXX has create too many chatrooms! | 该应用的创建聊天室达到上限。 | 删除不用的聊天室或联系商务调整上限。 |
