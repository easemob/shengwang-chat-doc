...
curl -X POST 'https://XXXX/app-id/{app_id}/chatrooms/XXXX/blocks/users/user1'  \
...
| 403     | forbidden_op | users [XX] are not members of this group! | 要添加黑名单的用户 ID 不在聊天室中。 | 传入聊天室黑名单中的成员的用户 ID。 |
