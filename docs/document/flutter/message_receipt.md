...
**群聊会话只支持消息已读回执，不支持送达回执**。群成员在发送消息时，可以设置该消息是否需要已读回执。要使用该功能，你需要在 [声网控制台](https://console.shengwang.cn/overview) 将即时通讯 IM 升级至旗舰版。
...
- 使用群消息已读回执前，已在 [声网控制台](https://console.shengwang.cn/overview) 将即时通讯 IM 升级至旗舰版。
...
| 使用限制| 默认 | 描述 | 
| :--------- | :----- | :------- | 
| 功能开通   | 关闭   | 若使用群聊消息已读回执，你需要在 [声网控制台](https://console.shengwang.cn/overview) 将即时通讯 IM 升级至旗舰版。 | 
