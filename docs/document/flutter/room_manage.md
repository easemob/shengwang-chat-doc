...
聊天室是支持多人沟通的即时通讯系统。聊天室中的成员没有固定关系，一旦离线后，不会收到聊天室中的任何消息，（除了聊天室白名单中的成员）超过 2 分钟会自动退出聊天室。聊天室可以应用于直播、消息广播等。若需调整该时间，需联系商务经理经理。
...
- 了解即时通讯 IM 不同版本的聊天室相关数量限制，详见 [产品套餐包功能对比](/product/product_package_feature.html)。
