...
除了满足用户离线条件外，要使用第三方离线推送，用户还需在[声网即时通讯控制台](https://console.easemob.com/user/login)配置推送证书信息，详见 [Android 推送](/document/android/push/push_fcm.html)和 [APNs 推送](/document/ios/push/push_apns.html)文档中各厂商证书配置描述。
