...
const documentV5Sidebar = [
  ...
  { text: '导入 SDK', link: 'integration.html', only: ['android', 'ios', 'harmonyos', 'web', 'unity', 'windows']},
  ...
  },
  {
    ...
    children: [
      ...
      { text: '用户信息自动管理', link: 'userinfo_provider.html', except: ['unity', 'windows']},
  ...
  },  
  {
    ...
    children: [
      ...
      { text: '管理群成员名片', link: 'group_namecard.html', except: ['unity', 'windows'] },
  ...
  },
  {
    ...
    children: [
      ...
      { 
        ...
        { text: '发送推送 token 到IM 服务器', link: 'push/push_send_token_to_server.html', only: ['react-native'] },
